...
type UsageReservation struct {
	...
	SettledNanousd       int64      `gorm:"not null;default:0;comment:权威结算金额(纳美元)"`
	SettledWeeklyCycleID uint       `gorm:"not null;default:0;index:idx_billing_usage_reservations_settled_weekly_cycle;comment:周额度实际结算周期ID"`
