...
var settingSpecs = []settingSpec{
	...
	{Namespace: "billing", Key: "mode", ValueType: "string", Default: "self", Description: "计费方式：self=自用模式，period=周期计费，usage=按量计费，weekly=统一周额度订阅",
		Validate: oneOf("self", "period", "usage", "weekly")},
