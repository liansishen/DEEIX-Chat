...
const THEME_PRESET_PREVIEWS: ThemePresetPreview[] = [
  ...
  },
  {
    ...
    value: "claude",
    light: {
      background: "oklch(0.9750 0.0080 65)",
      sidebar: "oklch(0.9600 0.0100 65)",
      sidebarBorder: "oklch(0.8900 0.0120 65)",
      surface: "oklch(0.9880 0.0050 65)",
      surfaceBorder: "oklch(0.8850 0.0120 65)",
      textStrong: "oklch(0.2400 0.0120 55)",
      textSoft: "oklch(0.5200 0.0180 55)",
      accent: "oklch(0.6000 0.1600 42.5)",
    },
    dark: {
      background: "oklch(0.2000 0.0080 55)",
      sidebar: "oklch(0.1800 0.0070 55)",
      sidebarBorder: "oklch(0.2600 0.0080 55)",
      surface: "oklch(0.2400 0.0080 55)",
      surfaceBorder: "oklch(0.3000 0.0080 55)",
      textStrong: "oklch(0.9200 0.0080 65)",
      textSoft: "oklch(0.6800 0.0120 60)",
      accent: "oklch(0.7000 0.1500 45)",
    },
  },
  {
    label: "Cobalt",
