            ...
            {planForm ? (
              <>
                ...
                <div className="grid grid-cols-2 gap-5">
                  ...
                  <div className="space-y-1">
                    <p className="text-xs text-muted-foreground">{t("plans.weeklyCredit")}</p>
                    <Input value={planForm.weeklyCredit} type="number" min="0" step="0.01" onChange={(event) => setPlanForm({ ...planForm, weeklyCredit: event.target.value })} />
                  </div>
                  <div className="space-y-1">
